...
export {
	...
	## The framework maintains a cache that maps unparsed version strings
	## to :zeek:type:`Software::Version` instances. This is its expiration
	## interval.
	const parse_cache_interval = 65secs &redef;

	## The framework maintains a redundancy cache that keeps the workers
	## from reporting the same version number observations repeatedly in
	## rapid succession. This is its expiration interval. Setting to 0secs
	## disables this cache.
