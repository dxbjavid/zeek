...
# The encrypted_client_hello extension carries an type; only
# the outer form (0) carries further data. The second variant
# should not occur in unencrypted packets.
